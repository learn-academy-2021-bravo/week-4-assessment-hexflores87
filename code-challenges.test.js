...
// // Expected output: [-59, 109]
  ...
  var arr = [3, 56, 90, -8, 0, 23, 6] // want to take the array and look at each number and figure out what the maximum numbers in that order
 var max = arr[0];
for (var i = 0; i< arr.length; i++){// loops through each element in the array and compare it to what the max is . So a for loop must be created
 if(arr[i] >= max){ // write a conditional statement. [i] will start at 0. 
    max = arr[i];
    
 }

 } 
 console.log(max)// When i test this I recieve 90 from my index. I'm not sure how to extract -8.

// take an argument 
// return array of the minimum and maximum nums in order

 var arr2 = [109, 5, 9, -59, 8, 24] // want to take the array and look at each number and figure out what the maximum numbers in that order
var max = arr2[0];
 for (var i = 0; i< arr.length; i++){// loops through each element in the array and compare it to what the max is . So a for loop must be created
if(arr2[i] >= max){ // write a conditional statement. [i] will start at 0. 
    max = arr2[i];
    
}

 } 
console.log(max)// When i test this I recieve 109 from my index. I'm not sure how to extract -59. I will bring this problem to office hours to see how to get retrieve the minimum and maximum.
// // b) Create the function that makes the test pass.
